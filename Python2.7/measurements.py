...
def main():
    ...
    measurements = Measurements(genome, "Measurements/data/25-200/", "Measurements/results/25-200", pieces_number=1000, start=25, end=200, step=25)
    ...
    # measurements2 = Measurements(genome, "Measurements/data/250-2000/", "Measurements/results/250-2000", pieces_number=100, start=250, end=2000, step=250)
    # measurements2.run_all_basic()
    # measurements2.run_all_pocl()
    
    """
    measurements3 = Measurements(genome, "data/25-200/", "results/25-200", pieces_number=1000, start=25, end=200, step=25)
    measurements3.run_all_basic()
    measurements3.run_all_pocl()

    measurements4 = Measurements(genome, "data/250-2000/", "results/250-2000", pieces_number=1000, start=250, end=2000, step=250)
    measurements4.run_all_basic()
    measurements4.run_all_pocl()
    """	
